...
describe("AIToolExecutionService", () => {
    ...
    it("should execute tool when AI response contains tool call", async () => {
    ...
    it("should return undefined when no tool requested", async () => {
    ...
    it("should return failed result when requested tool does not exist", async () => {
