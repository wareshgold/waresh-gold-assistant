...
const IMAGE = {
  ...
  pendantClassic: "https://images.pexels.com/photos/34444126/pexels-photo-34444126.jpeg?auto=compress&cs=tinysrgb&w=900",
...
export const PRODUCTS: Product[] = [
  ...
  { id: 8, name: "آویز ستاره", category: "آویز", weight: 1.2, laborPercent: 6, profitPercent: 7, taxPercent: 0, icon: "✦", image: IMAGE.pendantClassic, description: "آویز ستاره درخشان", shippingNote: SHIPPING_NOTE },
  { id: 9, name: "النگو ساده", category: "النگو", weight: 15.5, laborPercent: 4, profitPercent: 7, taxPercent: 0, icon: "◯", image: IMAGE.braceletWhite, description: "النگو ساده و شیک", shippingNote: SHIPPING_NOTE },
  ...
  { id: 17, name: "انگشتر مردانه ساده", category: "مردانه", weight: 5.8, laborPercent: 5, profitPercent: 7, taxPercent: 0, icon: "◉", image: IMAGE.ringSimple, description: "انگشتر مردانه ساده و شیک", shippingNote: SHIPPING_NOTE },
